...
$(function() {
  ...
  if(bgndKenburns.length){
    bgndKenburns.vegas({
      ...
      slides: [
        { src: "https://dummyimage.com/1000x1200/525252/787878" },
        { src: "https://dummyimage.com/1000x1200/525252/787878" },
        { src: "https://dummyimage.com/1000x1200/525252/787878" }
      ],
  ...
  if(bgndKenburnsFull.length){
    bgndKenburnsFull.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "https://dummyimage.com/1920x1080/525252/787878" },
        { src: "https://dummyimage.com/1920x1080/525252/787878" },
        { src: "https://dummyimage.com/1920x1080/525252/787878" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
  ...
  $('#countdown-large').countdown({until: $.countdown.UTCDate(+10, 2023, 4, 17), format: 'DHMS'});
  // --------------------------------------------- //
  // KBW-Countdown End
  // --------------------------------------------- //
